...
class Navigation extends PureComponent {
    ...
    static chooseAnimationStyle(NavigationSceneRendererProps, state) {
        ...
        switch (animationStyle) {
            ...
            case 'top2bottom':
                return topToBottom(NavigationSceneRendererProps)
            case 'fade':
    ...
    _renderCard(NavigationSceneRendererProps) {
        ...
        const {
            route
        } = NavigationSceneRendererProps.scene
    ...
    render() {
        ...
        const options = {}
        return ( <NavigationTransitioner style={styles.animatedView} navigationState={navigationState} 
        configureTransition={this._configureTransition} render={this._renderCard} {...options}/>
        )
    }
}
